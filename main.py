...
gdv_df = pd.read_csv('Data/gdv_data_1000pt.csv')
#--------------------------------------------------------------------------------------------------------------------------------------
cols = gdv_df.columns
gdvplot = plot_trend(gdv_df, title='GDV Trends through the layers')
gdvplot.write_image(default_path+'/infographics/layerwise_gdv.png')
